...
API_ID = int(environ.get('API_ID', '22719348'))
API_HASH = environ.get('API_HASH', '3990c93c6f52ee60d3c005d8b9c445a2')
BOT_TOKEN = environ.get('BOT_TOKEN', "8193181409:AAF5NGFiXYSlOFwI9m4UsuUkDc8-_MB2hJ4")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://graph.org/file/c79a6bb83af982d9b681e-31c8c2803f1963c6fe.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5857491193').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002569408028')

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002300089308').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://temaga6324:rolex143@cluster0.hinoe.mongodb.net/?retryWrites=true&w=majority")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/c14c05dc35ad2bf7722e8-340708660e717bf811.jpg') # payment code picture url.
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/DARKEY_BOI')
...
VERIFY_SHORTLINK_URL = environ.get('VERIFY_SHORTLINK_URL', 'https://arolinks.com')
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '7870a2c4056ef87aa5052ed7f871c01f16c3191e')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/ONE_PIECE_DIS')
...
SHORTLINK_API = environ.get('SHORTLINK_API', '8995c24f5c7d3c69ffde4a82d0c6a0c2bc5da10f')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Sk_entertains/18') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
